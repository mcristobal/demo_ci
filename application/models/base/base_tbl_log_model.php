...
* Fecha: 04/11/2011
****/
class tbl_log_model_condiciones{
...
* Fecha: 04/11/2011
****/	
class Base_tbl_log_model extends Model {
	
	// ***********************************
	// @copyright MC
	// declarando variables sobre la tabla       
	var $tabla = 'tbl_log';
	var $alias_tabla = 'tbl_log';
	var $id_tabla = 'pk_log';
  ...
  ****/
  ...
  function __construct(){
        parent::Model();        
        $this->obj_campos = new tbl_log_model_atributos();
        $this->obj_campos_mostrar = new tbl_log_model_seleccion();
        $this->obj_condiciones = new tbl_log_model_condiciones();
        $this->obj_orden = new tbl_log_model_orden();
        $this->set_join();
        $this->set_group_by();
  }
  ...
  ****/
  ...
  function get_pk(){
      $rpta = $this->obj_campos->pk_log;
    if($rpta == "") $rpta = "";
    return $rpta;
  }
  function get_pk_log(){
    return $this->obj_campos->pk_log;
  }
  function get_int_dni(){
    return $this->obj_campos->int_dni;
  }
  function get_int_tipo(){
    return $this->obj_campos->int_tipo;
  }
  function get_ip(){
    return $this->obj_campos->ip;
  }
  ...
  ****/
  ...
  function set_pk($value = ""){
    if($value!="")
      $this->obj_campos->pk_log = $value;
  }
  function set_pk_log($value = ""){
    if($value!="")
      $this->obj_campos->pk_log = $value;
  }
  function set_int_dni($value = ""){
    if($value!="")
      $this->obj_campos->int_dni = $value;
  }
