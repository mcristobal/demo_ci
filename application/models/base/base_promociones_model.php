...
* Fecha: 04/11/2011
****/
class promociones_model_atributos{
	// ********************************
	// @copyright MC
...
* Fecha: 04/11/2011
****/
class promociones_model_seleccion{
...
* Fecha: 04/11/2011
****/
class promociones_model_condiciones{
...
* Fecha: 04/11/2011
****/	
class Base_promociones_model extends Model {
	
	// ***********************************
	// @copyright MC
	// declarando variables sobre la tabla
	var $tabla = 'promociones';
	var $alias_tabla = 'promociones';
	var $id_tabla = 'id';
  ...
  ****/
  ...
  function __construct(){
        parent::Model();
        $this->obj_campos = new promociones_model_atributos();
        $this->obj_campos_mostrar = new promociones_model_seleccion();
        $this->obj_condiciones = new promociones_model_condiciones();
        $this->obj_orden = new promociones_model_orden();
        $this->set_join();
        $this->set_group_by();
  }
  ...
  ****/
  ...
  function get_fecha_inicio(){
    return $this->obj_campos->fecha_inicio;
  }
  function get_fecha_fin(){
    return $this->obj_campos->fecha_fin;
  }
  ...
  ****/
  ...
  function set_fecha_inicio($value = ""){
    if($value!="")
      $this->obj_campos->fecha_inicio = $value;
  }
  function set_fecha_fin($value = ""){
    if($value!="")
      $this->obj_campos->fecha_fin = $value;
  }
