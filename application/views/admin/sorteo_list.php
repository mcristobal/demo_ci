...
$(document).ready(function() {
	$(".botonExcel").click(function(event) {
		$("#datos_a_enviar").val( $("<div>").append( $("#id_tabla_listado").eq(0).clone()).html());
...
<div id="web_dinamico">
   <?php
        $atributos = array('name' => 'FormularioExportacion', 'id' => 'FormularioExportacion');
        echo form_open('admin/sorteo/demo',$atributos);
   ?>
    

        <div id="web_moduloInterno">
            <div id="web_moduloCabecera">
                <h3>SORTEO DE GANADORES</h3>
                <h4>LISTADO</h4>
            </div>
            <div id="web_moduloContenido">
                
                    <span>Exportar a Excel
                        <img src="<?php echo site_url();?>/images/export_to_excel.gif" class="botonExcel" />
                    </span>                    
                ...
                <div id="web_moduloListadoRegistros">
                    <table cellspacing="0" summary="registros" class="web_tableRegistros" id="id_tabla_listado">
                        ...
                        <?php
                        $y = 1;
                        foreach($obj_lima_suplente as $key => $obj_lima_suplentes):
                         if ($key >=21){
?>
                        <tr class="web_trFilaRegistros1">
                            <td><?php echo $y;?></td>
                        ...
                        <?php 
                        $y = 11;
                        foreach($obj_chiclayo_suplente as $key => $obj_chiclayo_suplente):
                         if ($key >=8){
?>
                        <tr class="web_trFilaRegistros1">
                            <td><?php echo $y;?></td>
                        ...
                        <?php
                        $y = 16;
                        foreach($obj_piura_suplente as $key => $obj_piura_suplente):
                         if ($key >=7){
?>
                        <tr class="web_trFilaRegistros1">
                            <td><?php echo $y;?></td>
                        ...
                        <?php 
                        //$y = 16;
                        foreach($obj_chimbote_suplente as $key => $obj_chimbote_suplente):
                         if ($key >=4){
?>
                        <tr class="web_trFilaRegistros1">
                            <td><?php //echo $y;?></td>
                        ...
                        <?php
                        $y = 19;
                        foreach($obj_iquitos_suplente as $key => $obj_iquitos_suplente):
                         if ($key >=4){
?>
                        <tr class="web_trFilaRegistros1">
                            <td><?php echo $y;?></td>
                        ...
                        <?php
                        $y = 20;
                        foreach($obj_pucallpa_suplente as $key => $obj_pucallpa_suplente):
                         if ($key >=5){
?>
                        <tr class="web_trFilaRegistros1">
                            <td><?php echo $y;?></td>
                        ...
                        <?php
                        $y = 22;
                        foreach($obj_huancayo_suplente as $key => $obj_huancayo_suplente):
                         if ($key >=5){
?>
                        <tr class="web_trFilaRegistros1">
                            <td><?php echo $y;?></td>
                        ...
                        <?php
                        $y = 24;
                        foreach($obj_cusco_suplente as $key => $obj_cusco_suplente):
                         if ($key >=4){
                        ?>
                        <tr class="web_trFilaRegistros1">
                            <td><?php echo $y;?></td>
